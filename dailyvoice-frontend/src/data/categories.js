export const CATEGORIES = {
  politics: {
    ...
    breaking: [
      { id: 11, title: "Asia Cup controversy: ICC drops the hammer! Full list of player...", img: "cricket" },
      { id: 12, title: "Ben Stokes signs England deal until 2027 Ashes", img: "cricket" },
      { id: 13, title: "Diamond jewellery, solar panels and 297% prize money...", img: "cricket" },
      { id: 14, title: "4 sixes, 9 fours, 93 runs! Vaibhav Suryavanshi's...", img: "cricket" }
    ],
    belowBreaking: [
