...
const BelowBreakingNews = ({ items,onArticleClick  }) => (
  <div>
    ...
    <div className="space-y-4">
      {items.map((item) => (
        <div key={item.id} className="flex gap-4 bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all hover:-translate-y-1 border border-gray-100 cursor-pointer"
